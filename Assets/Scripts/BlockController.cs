...
public class BlockController : MonoBehaviour
{
    ...
    */
    ...
    public Tuple<Tuple<bool,bool,bool,bool>,List<Tuple<int, int>>> getNeighbors(List<Tuple<int, int>>myBlocks)
    {
        ...
        bool player2 = false;
        bool player3 = false;
        Tuple<Tuple<bool, bool, bool, bool>, List<Tuple<int, int>>> outPutTuple;
        ...
        outPutTuple = new Tuple<Tuple<bool, bool, bool, bool>, List<Tuple<int, int>>>(touchedNeighbors, outPut);
        return outPutTuple;
    }
    ...
    public int getEarn(int areaNum)
    {
        return (int) ((1 - (double)1 / areaNum) * blockOriginalEarn * areaNum);
    }
